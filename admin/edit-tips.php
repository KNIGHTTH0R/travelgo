...
<title>Kristal Tour Admin :: Edit Tips</title>
</head>
<?php
if(isset($_POST['submit'])) 
{
		...
		if(empty($content)){
			...
			$sql = mysql_query("update tips set content='$content', post_date='$post_date', post_time='$post_time' where id_tips='$id'") or die(mysql_error());
...
<?php
		$id = antiinjection($_GET['id']);
		$sql = mysql_query("select * from tips where id_tips='$id'");
		$tips=mysql_fetch_array($sql);
?>
<body>
<!-- Header -->
<div class="row">
...
<div class="row">
       ...
       <div class="col-md-6">
       		<div class="container">
            		<div class="jumbotron">
                    	<form action="<?php echo $_SERVER['PHP_SELF']."?id=".$tips['id_tips']; ?>" method="post" class="form" role="form">
                            <div class="row">
                                <div class="col-xs-6">
                                    <legend>Edit Tips</legend>
                                    <?php echo $error; ?>
                                  	<lebel>Tips</lebel>
                                    <textarea name="content" reqiured><?php echo $tips['content']; ?></textarea>
                                </div>
                            </div>
                            <br />	
