...
<html class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="<? echo base_url('assets/cssLanding/mainB2b.css'); ?>">
        ...
        <div class="container app-showcase wow fadeInDown" data-wow-delay=".5s">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h2 class="text-center"><b>Welcome</b></br>to the Services business to business</h2>
                    <h3 class="text-center"><img class="banner-logo" src="<? echo base_url('assets/images/logo.svg'); ?>"></h3>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center wow fadeInUp" data-wow-delay=".5s">
                        <h2><b>Why look for product at Travelgo?</b></h2>
