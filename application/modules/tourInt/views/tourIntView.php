        ...
        <div class="container app-showcase wow fadeInDown" data-wow-delay=".5s">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h2 class="text-left"><b class="tittle-head">TOUR INTERNATIONAL</b></h2>
            ...
            <div class="row row-0-gutter">
                ...
                <div class="col-md-4 col-0-gutter">
                    <div class="ot-portfolio-item">
                        <figure class="effect-bubba" data-tour='bangkok' onclick='goDetail(this)'>
                            <img src="<? echo base_url('assets/imagesLanding/tour/portfolio-1.jpg'); ?>" alt="img02" class="img-responsive">
                            <figcaption>
                                <h2 class="in-Block">BANGKOK-PATTAYA</h2>
